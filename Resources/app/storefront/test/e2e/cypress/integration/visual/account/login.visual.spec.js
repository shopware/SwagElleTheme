...
describe('Account: Visual tests login as customer', () => {
    ...
    it('@visual: check appearance of login with wrong credentials', () => {
        ...
        cy.takeSnapshot('[Account] Menu icon', '.account-menu-dropdown');
        ...
        cy.takeSnapshot('[Account] Login with invalid credentials', accountPage.elements.loginCard);
        ...
        cy.takeSnapshot('[Account] Login with valid credentials', '.account');
    });
});
