...
describe('Checkout: as a guest', () => {
    ...
    it('@checkout: Run checkout with the same address', () => {
        ...
        cy.takeSnapshot('[Checkout] Product details', '.product-detail',{widths: [375, 768, 1920]});
        ...
        cy.takeSnapshot('[Checkout] Off canvas', '.offcanvas', {widths: [375, 768, 1920]});
        ...
        cy.takeSnapshot('[Checkout] Fill up information with the same address', '.checkout-container', {widths: [375, 768, 1920]});
        ...
        cy.takeSnapshot('[Checkout] Confirm information', '.checkout-container', {widths: [375, 768, 1920]});
    ...
    it('@checkout: Run checkout with the different shipping address', () => {
        ...
        cy.takeSnapshot('[Checkout] Fill up information with a different shipping address', '.checkout-container', {widths: [375, 768, 1920]});
